<template>
  <div class="property-panel">
    <div class="panel-header">
      ...
      <el-button v-if="currentComponent" type="danger" size="small" plain @click="deleteCurrentComponent">
...
.property-buttons :deep(.el-button) {
  width: 100%;
...
.property-panel :deep(.el-slider) {
  --el-slider-main-bg-color: var(--color-primary);
  --el-slider-runway-bg-color: var(--color-surface-muted);
}
